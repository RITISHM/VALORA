...
export default function InvoiceDetail() {
  ...
  const handleConfirmPayment = async () => {
    ...
    try {
      ...
      if (paymentData.payment_via === "ONLINE") {
        ...
        // Fetch order details
        const orderRes = await fetch(`${BACKEND_URL}/portal/invoices/${id}/razorpay-order`, {
          method: "POST",
          headers: {
        ...
        const options = {
          ...
          handler: async function (response) {
            ...
            try {
              const verifyRes = await fetch(`${BACKEND_URL}/portal/invoices/${id}/pay`, {
                method: "POST",
                headers: {
  ...
  useEffect(() => {
    const fetchInvoice = async () => {
      try {
        ...
        const cachedInvoice = cachedInvoices.find(
          (inv) => inv.id === parseInt(id, 10) || inv.id === id,
        );
    ...
    <div style={{ maxWidth: "1000px", margin: "0 auto", padding: "24px" }}>
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
          ...
          <h1 style={{ margin: 0, color: "#111116", fontSize: "1.5rem" }}>
      ...
      >
        ...
        >
          <div>
            ...
            <p style={{ margin: 0, fontWeight: "600", color: "#111116" }}>
            ...
            <tbody>
              {invoice.lines?.map((line, index) => (
                <tr key={line.id} style={{ borderBottom: "1px solid #F3F4F6" }}>
                  ...
                  <td style={{ padding: "16px 24px", fontSize: "0.9rem", color: "#6B7280" }}>
                    {line.analytic_account?.name || "-"}
                  </td>
                  <td style={{ padding: "16px 24px", fontSize: "0.9rem", color: "#111116" }}>
                    {line.qty}
                  </td>
                  <td style={{ padding: "16px 24px", fontSize: "0.9rem", color: "#111116" }}>
        ...
        >
          <div style={{ width: "300px" }}>
            <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "12px" }}>
              ...
              <span style={{ color: "#111116", fontWeight: "500" }}>
            ...
            >
              ...
              <span style={{ color: "#111116", fontWeight: "700", fontSize: "1.2rem" }}>
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <label
                  style={{ width: "140px", fontWeight: "700", color: "#4B5563", paddingTop: "4px" }}
                >
                  Memo / Note
                </label>
                <div style={{ flex: 1, borderBottom: "1px solid #D1D5DB", paddingBottom: "4px" }}>
