            ...
            {items.length === 0 ? (
              <div style={{ padding: "40px", textAlign: "center", color: "#6B7280" }}>
                ...
                <button
                  ...
                  style={{ marginTop: "16px", padding: "8px 24px", borderRadius: "8px" }}
                >
                  Continue Shopping
                </button>
              </div>
          ...
          >
            ...
            <button
              ...
              style={{
                ...
                gap: "8px",
                fontSize: "1rem",
                backgroundColor: items.length === 0 ? "#9CA3AF" : undefined,
              }}
            >
            ...
            >
              By clicking "Buy Now", an official invoice will be generated in your dashboard for
              immediate payment.
            </p>
          </div>
        </div>
