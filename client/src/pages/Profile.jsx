      ...
      <div style={{ backgroundColor: '#FFFFFF', padding: '32px', borderRadius: '16px', border: '1px solid #F3F4F6', maxWidth: '800px', display: 'flex', gap: '32px', alignItems: 'flex-start' }}>
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '20px' }}>
          <div>
            ...
            <span style={{ color: '#714B67', fontWeight: '600', backgroundColor: 'rgba(113, 75, 103, 0.1)', padding: '4px 12px', borderRadius: '20px', fontSize: '0.85rem', textTransform: 'capitalize' }}>
