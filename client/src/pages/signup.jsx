...
export default function Signup() {
    ...
    const handleSignup = async (e) => {
        ...
        try {
            const mappedRole = 'CONTACT'; // Strictly contact for the public signup page
            ...
            const response = await fetch(`${BACKEND_URL}/auth/signup`, {
                ...
                body: JSON.stringify({
                    ...
                    login_id: formData.email.trim(), // Use email as login_id for customers
                        ...
                        {(formData.password.length > 0 || touched.password) && (
                            <div className="password-criteria-box">
                                ...
                                <div className="criteria-list">
                                    {/* Length (>8) */}
                                    <div
                                        className={`criteria-item ${passwordAnalysis.criteria.length ? 'met' : 'missing'
                                            }`}
                                    >
                                    ...
                                    {/* Uppercase */}
                                    <div
                                        className={`criteria-item ${passwordAnalysis.criteria.uppercase ? 'met' : 'missing'
                                            }`}
                                    >
                                    ...
                                    {/* Lowercase */}
                                    <div
                                        className={`criteria-item ${passwordAnalysis.criteria.lowercase ? 'met' : 'missing'
                                            }`}
                                    >
                                    ...
                                    {/* Special Character */}
                                    <div
                                        className={`criteria-item ${passwordAnalysis.criteria.special ? 'met' : 'missing'
                                            }`}
                                    >
