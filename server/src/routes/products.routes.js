...
router.post('/', authorize(['ADMIN', 'ACCOUNTANT']), (req, res, next) => controller.createProduct(req, res, next));
router.put('/:id', authorize(['ADMIN', 'ACCOUNTANT']), (req, res, next) => controller.updateProduct(req, res, next));
