...
const { authenticateToken, requireRole } = require('../middleware/role');
...
router.post('/invoices/:id/razorpay-order', (req, res, next) => controller.createRazorpayOrder(req, res, next));
